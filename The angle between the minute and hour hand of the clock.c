...
if (t > c)
{printf("%f degrees is the angle between the minute and the hour hand of the clock",c);
}

else
{printf("%f degrees is the angle between the minute and the hour hand of the clock",t);
}
